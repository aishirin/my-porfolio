...
const experiences = [

  {
    ...
    points: [
      "Developing user-friendly web pages Next.js and other related technologies.",
      ...
      "Creating new features and functionality to enhance the user experience",
      "Participating in code reviews and providing constructive feedback to other developers.",
      "Building reusable code for future using"
    ],
  },
  {
    title: "Frontend Developer ",
